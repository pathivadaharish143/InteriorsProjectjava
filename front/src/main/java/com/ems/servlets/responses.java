...
public class responses extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		for (customers cust : empList) {
			...
			out.println("<td><a class='btn btn-info' href='updatecustomer?Name=" + cust.getName()
					+ "'><i class=\"fa-solid fa-user-pen\"></i></a> <a class='btn btn-danger' href='delCustomer?Name="
					+ cust.getName() + "'><i class=\"fa-solid fa-user-slash\"></i></a></td>");
			out.println("</tr>");
		}
		out.println("</tbody>");
		out.println("<table/>");
